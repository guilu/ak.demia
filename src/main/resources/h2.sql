...
insert into BDD_AKDEMIA.TB00_USER(id,first_name,last_name,email,password,enabled,locked) VALUES
    (1,'Diego','B H','user@gmail.com','$2a$11$mHnuXEyBNkMw7IOVmgH99OOj0uTNw2e9qP7Gf3H91u7jGK1CMOkc.',true,false);
insert into BDD_AKDEMIA.TB00_USER(id,first_name,last_name,email,password,enabled,locked) VALUES
    (2,'Diego','B H','admin@gmail.com','$2a$11$mHnuXEyBNkMw7IOVmgH99OOj0uTNw2e9qP7Gf3H91u7jGK1CMOkc.',true,false);


insert into BDD_AKDEMIA.TB00_ROLE(NAME) VALUES ('ROLE_USER');
insert into BDD_AKDEMIA.TB00_ROLE(NAME) VALUES ('ROLE_ADMIN');
insert into BDD_AKDEMIA.TB00_ROLE(NAME) VALUES ('ROLE_EDITOR');

insert into BDD_AKDEMIA.TB00_PRIVILEGE(NAME) VALUES ('READ_PRIVILEGE');
insert into BDD_AKDEMIA.TB00_PRIVILEGE(NAME) VALUES ('WRITE_PRIVILEGE');
insert into BDD_AKDEMIA.TB00_PRIVILEGE(NAME) VALUES ('BLOG_PRIVILEGE');

INSERT INTO BDD_AKDEMIA.TB00_ROLE_PRIVILEGE(ID_ROLE,ID_PRIVILEGE) VALUES (1,1); -- USER

INSERT INTO BDD_AKDEMIA.TB00_ROLE_PRIVILEGE VALUES (2,1); -- ADMIN
INSERT INTO BDD_AKDEMIA.TB00_ROLE_PRIVILEGE VALUES (2,2);
INSERT INTO BDD_AKDEMIA.TB00_ROLE_PRIVILEGE VALUES (2,3);

INSERT INTO BDD_AKDEMIA.TB00_ROLE_PRIVILEGE VALUES (3,1); -- EDITOR
INSERT INTO BDD_AKDEMIA.TB00_ROLE_PRIVILEGE VALUES (3,3);
...
INSERT INTO BDD_AKDEMIA.tb03_pregunta(ID,TEXTO,TEMA_ID) VALUES (1,'¿Qué Artículo de la Constitución está dedicado a la irretroactividad de las disposiciones  desfavorables o restrictivas de derechos individuales?',1),
                                                                        (2,'Según el Artículo 1.2 de la Constitución Española, ¿De dónde emanan los poderes del Estado?',1),
                                                                        (3,'¿Cómo se denomina el Título Preliminar de la C.E?',1),
                                                                        (4,'¿Por qué no están constituidas las fuerzas armadas?',1),
                                                                        (5,'Las bases de la organización militar se regulará conforme a los principios previstos en:',1),
                                                                        (6,'Según la Constitución Española de 1978, las banderas y enseñas propias de las Comunidades Autónomas: (Comunidad de Madrid, 2014)',1),
                                                                        (7,'La solidaridad entre las autonomías de las nacionalidades  y  regiones  que integran  la  nación española es  un derecho  que:',1),
                                                                        (8,'Según el Artículo 1 de la Constitución Española,  la  forma  política del  Estado  español es: (Comunidad  de Madrid,  2014)',1),
                                                                        (9,'Según la Constitución;  ¿Que  se  fundamenta en  la  indisoluble unidad de  la nación  española?',1),
                                                                        (10,'¿Quién está sujeto a la Constitución y al resto del ordenamiento jurídico?',1);


INSERT INTO BDD_AKDEMIA.tb04_respuesta(ID,CORRECTA,TEXTO,PREGUNTA_ID)  VALUES (1,false,'Artículo 9.2',1),
